            ...
            <table class="table table-striped mb-0">
              <thead>
                <tr>
                  ...
                  <th scope="col"><?php esc_html_e( 'Client Status', 'we-make-content-crm' ); ?></th>
                  <th scope="col"><?php esc_html_e( 'Meeting Time & link', 'we-make-content-crm' ); ?></th>
              ...
              <tbody>
                ...
                <?php foreach( $subscribers as $subscriber ) :
                  ...
                  if( $doc && ! empty( $doc->document_status ) ) {$is_signed = ( $doc->document_status == 'signed' );} else {$is_signed = null;}
                    //   Missing
                  $is_signed = ( $is_signed === null ) ? __( 'Pending', 'we-make-content-crm' ) : (
                    ( $is_signed === true ) ? __( 'Signed', 'we-make-content-crm' ) : __( 'Pending', 'we-make-content-crm' )
                  );
                  $is_active = $activeSubscription ? __( 'Active', 'we-make-content-crm' ) : __( 'Paused', 'we-make-content-crm' );
