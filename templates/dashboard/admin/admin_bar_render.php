    ...
    <nav class="nav navbar navbar-expand-xl navbar-light iq-navbar">
        <div class="container-fluid navbar-inner">
            <a href="../dashboard/index.html" class="navbar-brand">
                ...
                <!--logo End-->
                <h4 class="logo-title d-block d-xl-none" data-setting="app_name"><?php esc_html_e( 'CRM Dashboard', 'domain' ); ?></h4>
            </a>
            ...
            <div class="d-flex align-items-center justify-content-between product-offcanvas">
                ...
                <small class="mb-0 text-capitalize"><?php esc_html_e( 'Home', 'domain' ); ?></small>
                </div>
                ...
                <div class="offcanvas-body">
                    <ul class="iq-nav-menu list-unstyled">
                        <li class="nav-item ">
                            ...
                            <span class="nav-text ms-2"><?php esc_html_e( 'Home', 'domain' ); ?></span>
                            </a>
                        ...
                        <li class="">
                            ...
                            <div class="d-flex align-items-center border-bottom search-hover py-2 px-3">
                                    <div class="flex-shrink-0">
                                        <img src="https://templates.iqonic.design/product/qompac-ui/html/dist/assets/images/avatars/01.png" class="align-self-center img-fluid avatar-50 rounded-pill" alt="#">
                                    </div>
