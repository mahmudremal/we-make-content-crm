...
<main class="main-content">
  ...
  <div class="content-inner pb-0 container" id="page_layout">
    <div class="row">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between">
              ...
              <ul class="d-flex nav nav-pills mb-0 text-center profile-tab nav-slider" data-toggle="slider-tab" id="profile-pills-tab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                  <a class="nav-link" data-bs-toggle="tab" href="#profile-profile" role="tab" aria-selected="true" tabindex="-1"><?php esc_html_e( 'Profile',   'we-make-content-crm' ); ?></a>
                </li>
                <?php endif; ?>
      ...
      <?php include WEMAKECONTENTCMS_DIR_PATH . '/templates/dashboard/cards/notices.php'; ?>
      <div class="col-lg-3">
        <div class="card h-12">
          ...
          <div class="card-body">
            ...
            <p class="mt-4 text-center"><strong style="margin-right: 5px;"><?php esc_html_e( 'Joined:',   'we-make-content-crm' ); ?></strong> <?php echo esc_html( wp_date( 'M d, Y', strtotime( $userInfo->data->user_registered ) ) ); ?></p>
            ...
            <p class="mt-4 text-center"><strong style="margin-right: 5px;"><?php esc_html_e( 'Next Retainer:',   'we-make-content-crm' ); ?></strong> <?php echo esc_html( wp_date( 'M d, Y', (int) $subsc[ 'current_period_end' ] ) ); ?></p>
            <?php endif; ?>
            <div class="separator separator-dashed my-8"></div>
            <?php endif; ?>
            ...
            <ul class="list-inline m-0 p-0">
              ...
              <img src="<?php echo esc_url( WEMAKECONTENTCMS_BUILD_URI . '/icons/calendar-checklist-date-svgrepo-com.svg' ); ?>" alt="story-img" class="rounded-pill avatar-70 p-1 border bg-soft-light img-fluid" loading="lazy">
                <div class="ms-3">
              ...
              <li class="d-flex mb-4 align-items-center">
                ...
                <img src="<?php echo esc_url( WEMAKECONTENTCMS_BUILD_URI . '/icons/bookshelf-svgrepo-com.svg' ); ?>" alt="story-img" class="rounded-pill avatar-70 p-1 border img-fluid bg-soft-danger" loading="lazy">
                <div class="ms-3">
          ...
          <div id="profile-payments" class="tab-pane fade" role="tabpanel">
            ...
            <?php if( false && apply_filters( 'futurewordpress/project/system/isactive', 'stripe-cancelsubscription' ) ) : ?>
              ...
              <div class="col-lg-6 col-md-6">
                <div class="card text-center">
                  <div class="card-body payment-page-card">
                    <h3 class=""><?php esc_html_e( 'Subscription',   'we-make-content-crm' ); ?></h3>
                    ...
                    ] ) ); ?>" data-userid="<?php echo esc_html( $userInfo->ID ); ?>"><?php esc_html_e( 'Cancel', 'we-make-content-crm' ); ?></button>
                    <?php endif; ?>
                  </div>
                </div>
              </div>
                  ...
                  <table class="table mb-0 fwp-datatable-field" data-toggle="data-table">
                    <thead>
                      <tr class="bg-white">
                        ...
                        <th><?php esc_html_e( 'Invoice',   'we-make-content-crm' ); ?></th>
                      </tr>
                    </thead>
                    <tbody>
                      ...
                      <?php else : ?>
                        ...
                        <tr>
                          ...
                          <td><?php echo esc_html( ( $pay[ 'paid' ] ) ? __( 'Paid', 'we-make-content-crm' ) : __( 'Unpaid', 'we-make-content-crm' ) ); ?></td>
                          <td>
                            <div class="d-flex justify-content-evenly">
