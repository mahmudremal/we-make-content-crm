      ...
      <div class="row no-gutters align-items-center bg-white">      
        <div class="col-md-12 col-lg-6 align-self-center">
          <div class="navbar-brand d-flex align-items-center mb-3 justify-content-center text-primary">
            ...
            <h2 class="logo-title ms-3 mb-0" data-setting="app_name"><?php echo esc_html( ( $result[ 'payment_status' ] == 'paid' ) ? __( 'Payment Successful',   'we-make-content-crm' ) : __( 'Payment Failed',   'we-make-content-crm' ) );
            esc_html_e( '',   'we-make-content-crm' ); ?></h2>
          </div>
          <div class="row justify-content-center pt-5">
            <div class="col-md-8">
              <div class="card  d-flex justify-content-center mb-0">
              <div class="card-body">
                  <h2 class="mt-3 mb-4"><?php echo esc_html( ( $result[ 'payment_status' ] == 'paid' ) ? __( 'Success !',   'we-make-content-crm' ) : __( 'Failed !',   'we-make-content-crm' ) ); ?></h2>
                  <p class="cnf-mail mb-1"><?php echo wp_kses_post( ( $result[ 'payment_status' ] == 'paid' ) ? 
                  __( 'Congratulations! Your subscription has been successfully processed. As a next step, please click here to sign the necessary documents and complete the process. Thank you for choosing us and we look forward to serving you. If you have any questions or concerns, please don\'t hesitate to reach out to us. We are always here to help.',   'we-make-content-crm' ) : 
                  __( nl2br( "Unfortunately, your payment has failed.\nDon\'t worry,we understand that things happen. To try again, please click the button below. \nIf you need assistance or have any questions, please reach out to our support team for help. \n\nPlease note that until your payment is successful, you will not be able to proceed with the contract. We encourage you to try again as soon as possible. Thank you for your understanding." ),   'we-make-content-crm' ) ); ?></p>
                  <div class="d-inline-block w-100">
                    <a href="<?php echo esc_url( apply_filters( 'futurewordpress/project/user/dashboardpermalink', $userInfo->ID, $userInfo->data->user_nicename ) ); ?>/sign/" class="btn btn-primary mt-3"><?php esc_html_e( 'Sign the Document',   'we-make-content-crm' ); ?></a>
                  </div>
              </div>
            </div>
            </div>
        ...
        <div class="col-lg-6 d-lg-block d-none bg-primary p-0  overflow-hidden">
          ...
          <img src="<?php echo esc_url( WEMAKECONTENTCMS_BUILD_URI . '/img/img-to-contract.jpg' ); ?>" class="img-fluid gradient-main" alt="images" loading="lazy" >
        </div>
      </div>
    </section>
  </div>
