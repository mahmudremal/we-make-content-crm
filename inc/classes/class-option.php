...
class Option {
  ...
  private $file;
	...
	protected function setup_hooks() {
		$this->file = WEMAKECONTENTCMS_PROJECT__FILE__;
		$this->plugin_slug = 'we-make-content-crm';
		$this->plugin_name = 'we-make-content-crm';
		$this->textdomain = 'we-make-content-crm'; // str_replace('_', '-', $plugin_slug);
	...
	public function add_settings_link( $links ) {
		$settings_link = '<a href="options-general.php?page='.$this->general->slug.'">' . __( 'Settings', 'we-make-content-crm' ) . '</a>';
		// array_push( $links, $settings_link );
		$links[] = $settings_link;
		$links[] = '<a href="https://www.fiverr.com/mahmud_remal/" target="_blank">' . __( 'Developer Support', 'we-make-content-crm' ) . '</a>';
		return $links;
	}
