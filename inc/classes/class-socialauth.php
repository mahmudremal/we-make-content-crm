...
class SocialAuth {
	...
	protected function setup_hooks() {
		$this->facebookAppID					= apply_filters( 'futurewordpress/project/system/getoption', 'auth-googleclientid', 'facebook-app-id' );
		$this->facebookAppSecret			= apply_filters( 'futurewordpress/project/system/getoption', 'auth-googleclientid', 'facebook-app-secret' );
		...
		if( ! apply_filters( 'futurewordpress/project/system/isactive', 'auth-enable' ) ) {return;}
		/**
		 * Actions.
		 */
    ...
    $auth_provider = get_query_var( 'auth_provider' );
      ...
      return $template;
			...
			$file = WEMAKECONTENTCMS_DIR_PATH . '/templates/auth/index.php';
