...
class Rewrite {
  ...
  public function init() {
		...
		add_rewrite_rule( stripslashes( apply_filters( 'futurewordpress/project/system/getoption', 'permalink-dashboard', 'dashboard' ) ) . '/([^/]*)/([^/]*)/?', 'index.php?user_profile=$matches[1]&currenttab=$matches[2]', 'top' );
