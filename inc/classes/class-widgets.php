 ...
 */
 class Widgets {
	...
	public function register_sidebars() {
		register_sidebar(
			[
				'name'          => esc_html__( 'Sidebar', 'we-make-content-crm' ),
				'id'            => 'sidebar-1',
				'description'   => '',
		...
		register_sidebar(
			[
				'name'          => esc_html__( 'Footer', 'we-make-content-crm' ),
				'id'            => 'sidebar-2',
				'description'   => '',
	...
	public function register_clock_widget() {
		register_widget( 'WEMAKECONTENTCMS_THEME\Inc\Clock_Widget' );
	}
  public function register_widgets( $widgets_manager ) {
    $file = WEMAKECONTENTCMS_DIR_PATH . '/inc/widgets/elementor/widget-custom-category.php';
