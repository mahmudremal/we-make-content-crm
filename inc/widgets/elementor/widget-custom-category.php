...
class Widgets_CustomCategory extends \Elementor\Widget_Base {
	...
	public function __construct( $data = [], $args = null ) {
		...
		wp_register_style( 'listivo-child-widgets', WEMAKECONTENTCMS_BUILD_CSS_URI . '/widgets.css', [], apply_filters( 'futurewordpress/project/filesystem/filemtime', false, WEMAKECONTENTCMS_BUILD_CSS_DIR_PATH . '/widgets.css' ) );
		...
		wp_register_script( 'listivo-child-widgets', WEMAKECONTENTCMS_BUILD_JS_URI . '/widgets.js', [ 'swiper' ], apply_filters( 'futurewordpress/project/filesystem/filemtime', false, WEMAKECONTENTCMS_BUILD_JS_DIR_PATH . '/widgets.js' ), true );
	}
	/**
	 * Widget key.
	 * 
	...
	public function get_title() {
		return __( 'Custom Category Slider', 'we-make-content-crm' );
	}
	/**
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_content',
			array(
				'label' => __( 'Content', 'we-make-content-crm' ),
			)
		);
		$this->add_control(
			'show_view_all',
			[
				'label' => esc_html__('Display "View All" button', 'we-make-content-crm'),
		...
		$this->add_control(
			'view_all_style',
			[
				'label' => esc_html__('Style', 'we-make-content-crm'),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'left' => esc_html__('Left', 'we-make-content-crm'),
					'right' => esc_html__('Right', 'we-make-content-crm'),
				],
				'default' => 'left',
				'condition' => [
					'show_view_all' => '1',
		...
		$this->add_control(
			'view_all_title',
			[
				'label'   => __( 'Heading Text', 'we-make-content-crm' ),
				'type'    => Controls_Manager::TEXT,
				'default' => __( 'Heading Text', 'we-make-content-crm' ),
				'condition' => [
					'show_view_all' => '1',
				]
			]
		...
		$this->add_control(
			'show_viewall_btn',
			[
				'label' => esc_html__('Show button', 'we-make-content-crm'),
				'type' => Controls_Manager::SWITCHER,
				'return_value' => '1',
				'default' => '1',
			]
		...
		$this->add_control(
			'view_all_text',
			[
				'label' => esc_html__('View All Text', 'we-make-content-crm'),
		...
		$this->add_control(
			'view_all_btntxt',
			[
				'label'   => __( 'Button Text', 'we-make-content-crm' ),
				'type'    => Controls_Manager::TEXT,
				'default' => __( 'View all', 'we-make-content-crm' ),
				'condition' => [
					'show_view_all' => '1',
				]
			]
		...
		$this->add_control(
			'view_all_link',
			[
				'label'   => __( 'View all button link', 'we-make-content-crm' ),
				'type'    => Controls_Manager::TEXT,
				'default' => '',
				'condition' => [
					'show_view_all' => '1',
		...
		$this->add_control(
				'view_all_image',
				[
						'label' => esc_html__('Image', 'we-make-content-crm'),
		...
		$this->start_controls_section(
			'section_slider',
			array(
				'label' => __( 'Slider', 'we-make-content-crm' ),
			)
		);
		...
		$repeater->add_control(
			'label',
			[
				'label' => esc_html__('Category Label', 'we-make-content-crm'),
				'type' => Controls_Manager::TEXT,
				'placeholder' => __( 'Title Here', 'we-make-content-crm' ),
			]
		);
		$repeater->add_control(
			'link',
			[
				'label' => esc_html__('Category URL', 'we-make-content-crm'),
				'type' => Controls_Manager::TEXT,
				'placeholder' => __( 'Full URL of this category.', 'we-make-content-crm' ),
			]
		);
		$repeater->add_control(
			'color',
			[
				'label' => esc_html__('Background Color', 'we-make-content-crm'),
		...
		$this->add_control(
			'categories',
			[
				'label' => esc_html__('Category Items', 'we-make-content-crm'),
